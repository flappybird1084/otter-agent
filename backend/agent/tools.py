...
INBOX_TOOLS = [
    ...
    "list_friends",
    "reply_to_agent",
    # ask_user / confirm_action are also available in inbox mode: they ask the
    # RECEIVER (the human whose agent is currently running), not the sender,
    # so the receiver stays in the loop on anything sensitive a friend's agent
    # is trying to do on their behalf.
    "ask_user", "confirm_action",
